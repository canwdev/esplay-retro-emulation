...
- **游戏模拟器**（可选）— 整合 [retro-go](https://github.com/canwdev/retro-go-esplay-micro)，选中 ROM 自动启动模拟器，详见 [docs/RETRO-GO.md](docs/RETRO-GO.md)
...
| [docs/RETRO-GO.md](docs/RETRO-GO.md)             | Retro-Go 模拟器整合原理与刷入指南                                  |
